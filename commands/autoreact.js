...
module.exports = async (sock, chatId, message, args) => {
    ...
    if (sub==="on") { save({...d,enabled:true}); return reply(sock, chatId, `✅ Auto-react enabled! (${d.emoji})`, message); }
    if (sub==="off") { save({...d,enabled:false}); return reply(sock, chatId, "❌ Disabled.", message); }
