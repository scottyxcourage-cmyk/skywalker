...
module.exports = async (sock, chatId, message, args) => {
    const q = args.join(" ").trim(); if (!q) return reply(sock, chatId, "❌ Usage: .deepseek <question>", message);
    await sock.sendMessage(chatId, { text: "🧠 DeepSeek thinking..." }, { quoted: message });
    try {
        ...
        await reply(sock, chatId, `🧠 *DeepSeek*\n━━━━━━━━━━\n❓ ${q}\n\n💬 ${ans}`, message);
